...
// import the routes dynamically for esm compatibility
const { POST } = await import("@/app/api/friends/request/route");
const { PATCH } = await import("@/app/api/friends/accept/route");
const { DELETE } = await import("@/app/api/friends/remove/route");

// group all tests for the friend system api
