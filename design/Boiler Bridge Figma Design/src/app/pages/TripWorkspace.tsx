            ...
            <div className="flex items-center gap-1">
              {tripData.members.map((member) => (
                <Avatar key={member.id} className="w-8 h-8 border-2 border-white -ml-2 first:ml-0">
                  <AvatarFallback className={`text-xs bg-gradient-to-br ${member.color} text-white`}>
                    {member.initials}
                  </AvatarFallback>
                </Avatar>
              ))}
            ...
            {chatMessages.map((msg) => (
              <div key={msg.id} className="flex gap-3">
                <Avatar className="w-8 h-8 flex-shrink-0">
                  <AvatarFallback className={`text-xs bg-gradient-to-br ${msg.color} text-white`}>
                    {msg.user}
                  </AvatarFallback>
                </Avatar>
                <div className="flex-1">
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex gap-2">
              ...
              <Input
                ...
                className="flex-1"
              />
              <Button size="icon" className="bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white flex-shrink-0">
                <Send size={18} />
              </Button>
            </div>
          </div>
