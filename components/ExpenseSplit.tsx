                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Avatar className="w-10 h-10">
                        <AvatarFallback className={`bg-linear-to-br ${balance.color} text-white text-sm`}>
                          {balance.initials}
                        </AvatarFallback>
                      </Avatar>
                      <div>
                    ...
                    <Button
                      ...
                      className={balance.type === "owe" ? "bg-linear-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white" : ""}
                    >
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-2">
                    <Button
                      ...
                      className={filter === "all" ? "bg-linear-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white" : ""}
                    >
                      All
                    </Button>
                    <Button
                      ...
                      className={filter === "paid" ? "bg-linear-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white" : ""}
                    >
                      I Paid
                    </Button>
                    <Button
                      ...
                      className={filter === "owe" ? "bg-linear-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white" : ""}
                    >
                      I Owe
                    </Button>
                  </div>
