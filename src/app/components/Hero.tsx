...
export function Hero() {
  return (
    <section className="pt-32 pb-16 px-6 lg:px-8 bg-gradient-to-b from-amber-50 to-white">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-4">
              <Link to="/signin">
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-lg text-white"
                >
                  Start Planning Free
